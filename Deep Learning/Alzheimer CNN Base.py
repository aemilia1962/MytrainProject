...
# คอมไพล์โมเดล
custom_cnn_model.compile(optimizer='adam', loss=tf.losses.CategoricalCrossentropy(), metrics=METRICS)
...
test_scores = custom_cnn_model.evaluate(test_data, test_labels)
print("Testing Accuracy: %.2f%%" % (test_scores[1] * 100))

# ทำนายข้อมูลทดสอบ
pred_labels = custom_cnn_model.predict(test_data)
